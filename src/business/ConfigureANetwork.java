...
public class ConfigureANetwork {
    ...
    public static Network initialize() {
        ...
        enterpriseDirectory.findEnterprise("National Emergency Management Authority").setOrgDirectory(organizationDirectory1);
        enterpriseDirectory.findEnterprise("International Humanitarian Aid Corporation").setOrgDirectory(organizationDirectory2);
        enterpriseDirectory.findEnterprise("Global Resource Distribution Group").setOrgDirectory(organizationDirectory3);
        enterpriseDirectory.findEnterprise("Community").setOrgDirectory(organizationDirectory4);
        enterpriseDirectory.findEnterprise("Emergency Response Systems Ltd").setOrgDirectory(organizationDirectory5);
        
        CitizenDirectory citizenDirectory = new CitizenDirectory();

        Citizen lewisHamilton = citizenDirectory.newCitizen(1, "Volunteer Coordinator", "password123".toCharArray(), "VolunteerCoordinator",
                "1234567890", "Silverstone, UK", "British");
        Citizen maxVerstappen = citizenDirectory.newCitizen(2, "Damage Analyst", "password123".toCharArray(), "DamageAnalyst",
                "9876543210", "Zandvoort, Netherlands", "Dutch");
        Citizen charlesLeclerc = citizenDirectory.newCitizen(3, "Emergency Coordinator", "password123".toCharArray(), "EmergencyOperationCoordinator",
                "5555555555", "Monaco", "Monegasque");
        Citizen sergioPerez = citizenDirectory.newCitizen(4, "Field Coordinator", "password123".toCharArray(), "MedicalAdvisor",
                "1112223333", "Guadalajara, Mexico", "Mexican");
        Citizen carlosSainz = citizenDirectory.newCitizen(5, "Hospital Manager", "password123".toCharArray(), "SafetyInspector",
                "4445556666", "Madrid, Spain", "Spanish");
        Citizen landoNorris = citizenDirectory.newCitizen(6, "Logistics Coordinator", "password123".toCharArray(), "LogisticsManager",
                "7778889999", "Bristol, UK", "British");
        Citizen georgeRussell = citizenDirectory.newCitizen(7, "Resource Specialist", "password123".toCharArray(), "DisasterResponsePlanner",
                "1231231234", "Kings Lynn, UK", "British");
        Citizen fernandoAlonso = citizenDirectory.newCitizen(8, "Search Leader", "password123".toCharArray(), "SearchAndRescueLeader",
                "2223334444", "Oviedo, Spain", "Spanish");
        Citizen sebastianVettel = citizenDirectory.newCitizen(9, "Environmental Specialist", "password123".toCharArray(), "EnvironmentalSpecialist",
                "5556667777", "Heppenheim, Germany", "German");
        Citizen valtteriBottas = citizenDirectory.newCitizen(10, "Citizen", "password123".toCharArray(), "ResourceManager",
